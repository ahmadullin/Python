...
kub_player = random.randint(1, 6)
print (f"Значение игрального кубика Игрок: {kub_player}")
kub_bot = random.randint(1, 6)
print (f"Значение игрального кубика Бот: {kub_bot}")

if kub_player > kub_bot:
    player_1 = 'Игрок'
    player_2 = 'Бот'
    i = 0
